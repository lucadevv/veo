...
export const LIMA_PLACES: readonly LimaPlace[] = [
  ...
  },
  {
    ...
    lat: -12.1318,
    lon: -77.0306,
    aliases: ['centro comercial larcomar'],
  },
  ...
  // ─── Aeropuerto y transporte ─────────────────────────────────────────────────
  {
    ...
    lat: -12.0219,
    lon: -77.1143,
    aliases: ['aeropuerto', 'jorge chavez', 'lim', 'aeropuerto de lima'],
  },
  {
    name: 'Terminal Terrestre Plaza Norte',
    district: 'Independencia',
    kind: 'transport',
    lat: -11.9926,
    lon: -77.0598,
    aliases: ['terrapuerto plaza norte'],
  },
  {
    ...
    lat: -12.0606,
    lon: -77.0369,
    aliases: ['metropolitano'],
  },
  {
    name: 'Estación Gamarra',
  ...
  // ─── Parques ─────────────────────────────────────────────────────────────────
  {
    ...
    lat: -12.1211,
    lon: -77.0297,
    aliases: ['parque central miraflores'],
  },
  {
    name: 'El Olivar',
    district: 'San Isidro',
    ...
    lat: -12.0975,
    lon: -77.0386,
    aliases: ['bosque el olivar', 'parque el olivar'],
  },
  {
    ...
    lat: -12.0699,
    lon: -77.0339,
    aliases: ['circuito magico del agua'],
  },
  {
  ...
  { name: 'Barranco', district: 'Barranco', kind: 'district', lat: -12.149, lon: -77.021 },
  ...
  { name: 'Los Olivos', district: 'Los Olivos', kind: 'district', lat: -11.9706, lon: -77.07 },
  { name: 'Ate', district: 'Ate', kind: 'district', lat: -12.0258, lon: -76.9181 },
  {
    ...
    lat: -12.0464,
    lon: -77.0428,
    aliases: ['centro de lima', 'lima centro'],
  },
  ...
  },
  {
    ...
    lat: -12.057,
    lon: -77.083,
    aliases: ['unmsm', 'san marcos', 'ciudad universitaria'],
  },
  {
  ...
  {
    name: 'Hospital Guillermo Almenara',
    district: 'La Victoria',
    kind: 'hospital',
    lat: -12.0556,
    lon: -77.0186,
  ...
  // ─── Plazas y landmarks ──────────────────────────────────────────────────────
  {
    ...
    lat: -12.0464,
    lon: -77.0306,
    aliases: ['plaza de armas', 'plaza mayor'],
  },
  {
  ...
  },
  {
    ...
    lat: -12.1102,
    lon: -77.0334,
    aliases: ['ovalo gutierrez'],
  },
  {
    name: 'Óvalo de Miraflores',
    district: 'Miraflores',
    kind: 'plaza',
    lat: -12.1196,
    lon: -77.0289,
    aliases: ['ovalo miraflores'],
  },
  {
  ...
  },
  {
    ...
    lat: -12.07,
    lon: -77.082,
    aliases: ['universitaria'],
  },
  {
    name: 'Avenida Abancay',
    district: 'Cercado de Lima',
    kind: 'avenue',
    lat: -12.053,
    lon: -77.025,
