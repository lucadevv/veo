...
/**
 * Par ES256 compartido (PKCS8 + SPKI). Es el MISMO que ya viene commiteado en los `.env`
 * de identity-service / public-bff / driver-bff (clave de desarrollo, no de producción).
