...
export const INFRA = {
  postgresUrlBase:
    process.env.E2E_DATABASE_URL_BASE ?? 'postgresql://veo:veo_dev@localhost:5433/veo',
  ...
  return [
    {
      ...
      dbSchema: 'identity',
      env: {
        PORT: String(PORTS.identity),
        GRPC_URL: '0.0.0.0:50051',
        DATABASE_URL: dbUrl('identity'),
      },
    },
    {
      name: 'trip-service',
    ...
    },
    {
      ...
      dbSchema: 'payment',
      env: {
        PORT: String(PORTS.payment),
        GRPC_URL: '0.0.0.0:50055',
        DATABASE_URL: dbUrl('payment'),
      },
    },
    {
      name: 'panic-service',
    ...
    {
      name: 'rating-service',
      filter: '@veo/rating-service',
      cwd: 'services/rating-service',
      hasPrismaGenerated: true,
      healthAcceptAnyStatus: true,
      httpPort: 3010,
      grpcUrl: '0.0.0.0:50060',
      dbSchema: 'rating',
      env: { PORT: '3010', GRPC_URL: '0.0.0.0:50060', DATABASE_URL: dbUrl('rating') },
    },
    {
      name: 'fleet-service',
      filter: '@veo/fleet-service',
      cwd: 'services/fleet-service',
      hasPrismaGenerated: true,
      healthAcceptAnyStatus: true,
      httpPort: 3012,
      grpcUrl: '0.0.0.0:50062',
      dbSchema: 'fleet',
      env: { PORT: '3012', GRPC_URL: '0.0.0.0:50062', DATABASE_URL: dbUrl('fleet') },
    },
    {
      name: 'share-service',
      filter: '@veo/share-service',
      cwd: 'services/share-service',
      hasPrismaGenerated: true,
      healthAcceptAnyStatus: true,
      httpPort: 3011,
      grpcUrl: '0.0.0.0:50061',
      dbSchema: 'share',
      env: { PORT: '3011', GRPC_URL: '0.0.0.0:50061', DATABASE_URL: dbUrl('share') },
    },
    {
      name: 'notification-service',
      filter: '@veo/notification-service',
