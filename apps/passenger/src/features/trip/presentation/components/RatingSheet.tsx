 ...
 */
export function RatingSheet({ visible, onClose, children }: RatingSheetProps): React.JSX.Element {
  const { t } = useTranslation();
  return (
    <BottomSheet visible={visible} onClose={onClose} title={t('ratings.sheetTitle')}>
      {children}
    </BottomSheet>
  );
}
