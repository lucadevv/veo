 ...
 * Hermes). Bounding box de Lima Metropolitana (zona operativa, BR-D03) y centro por defecto para
...
/**
 * Distancia haversine en METROS entre dos puntos lat/lon. Aproximación esférica: para los ~decenas de
 * metros que separan dos fixes de GPS consecutivos el error es despreciable. PURA → testeable. Se usa
 * para el THROTTLE por umbral del seguimiento de cámara (re-encuadrar solo si el conductor se movió lo
 * suficiente, no en cada tick del socket).
 */
