...
export function buildContainer(): Container {
  ...
  container.register(
    ...
    (c) => new HttpSavedPlacesRepository(c.resolve(TOKENS.httpClient), prefsStore),
  );
  ...
  container.register(TOKENS.localAuthService, () => new KeychainLocalAuthService());
  // Selector de imágenes nativo (avatar): galería + cámara tras el puerto `ImagePickerService`.
  container.register(TOKENS.imagePickerService, () => new NativeImagePickerService());
  ...
  container.register(TOKENS.panicSecretStore, () => new KeychainPanicSecretStore());
  container.register(
    TOKENS.panicSigner,
  ...
  container.register(
    ...
    (c) => new CreateYapeAffiliationUseCase(c.resolve(TOKENS.affiliationRepository)),
  );
  container.register(
    TOKENS.revokeYapeAffiliationUseCase,
    (c) => new RevokeYapeAffiliationUseCase(c.resolve(TOKENS.affiliationRepository)),
  );
  ...
  container.register(
    ...
    (c) => new ListNotificationsUseCase(c.resolve(TOKENS.notificationsRepository)),
  );
