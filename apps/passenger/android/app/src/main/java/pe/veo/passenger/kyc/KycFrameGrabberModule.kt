...
/**
 * Módulo nativo de captura de frames del KYC del PASAJERO (frame-grabber REAL) sobre Camera2.
 *
 ...
 */
class KycFrameGrabberModule(reactContext: ReactApplicationContext) :
  ...
  private class CaptureSession(
    ...
    private val thread = HandlerThread("veo-kyc-camera").apply { start() }
  ...
  companion object {
    const val NAME = "VeoKycFrameGrabber"
    private const val ERR_CAPTURE = "E_KYC_CAPTURE"
