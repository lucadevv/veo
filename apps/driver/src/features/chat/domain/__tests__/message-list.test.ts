...
import {isOwnMessage, mergeMessages, sortMessages, upsertMessage} from '../value-objects/message-list';
...
describe('chat/message-list', () => {
  describe('isOwnMessage', () => {
    it('marca como propio solo el rol DRIVER', () => {
      expect(isOwnMessage(msg({id: 'a', createdAt: '2026-05-30T10:00:00.000Z', senderRole: 'DRIVER'}))).toBe(true);
      expect(isOwnMessage(msg({id: 'b', createdAt: '2026-05-30T10:00:00.000Z', senderRole: 'PASSENGER'}))).toBe(false);
    });
  });
  ...
  describe('upsertMessage', () => {
    ...
    it('es idempotente: reentregar el mismo id no duplica la burbuja', () => {
      ...
      const out = upsertMessage(base, msg({id: 'a', createdAt: '2026-05-30T10:00:00.000Z', body: 'v2'}));
