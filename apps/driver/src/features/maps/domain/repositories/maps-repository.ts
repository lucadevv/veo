 ...
 * cubre el autocompletado de direcciones y el geocoding inverso (etiqueta de un punto). Implementación
 * concreta en `data/` contra el driver-bff (`/maps/*`); el cliente nunca habla con proveedores de mapas
 * directos (la infra soberana OSRM/Nominatim vive detrás del BFF).
 */
