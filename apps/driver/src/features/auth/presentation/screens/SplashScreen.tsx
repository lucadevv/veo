  ...
  return (
    <View style={[styles.root, {backgroundColor: theme.colors.bg}]}>
      ...
      <Svg
        ...
        <Circle cx={300} cy={66} r={16} stroke={theme.colors.accent} strokeOpacity={0.4} strokeWidth={2} fill="none" />
        <Circle cx={150} cy={400} r={6} fill={theme.colors.bg} stroke={theme.colors.accent} strokeWidth={3} />
      </Svg>
