        ...
        {isPreview ? (
          ...
          <Reveal delay={120} spring style={styles.ringArea}>
            ...
            <View style={styles.hintLeft} pointerEvents="none">
              <HintChip icon={<SunGlyph color={theme.colors.accent} />} label={t('registration.kyc.goodLight')} />
            </View>
            <View style={styles.hintRight} pointerEvents="none">
              <HintChip icon={<FaceGlyph color={theme.colors.accent} />} label={t('registration.kyc.lookAhead')} />
            </View>
          </Reveal>
        )}
            ...
            <Pressable
              ...
              <View
                ...
                {isBusy ? (
                  ...
                  <View
                    style={[styles.captureInner, {backgroundColor: hexAlpha(theme.colors.accent, 0.18)}]}
                  />
                )}
              </View>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  intro: {gap: 6},
  ringArea: {height: RING, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', width: '100%'},
  hint: {alignItems: 'center', paddingHorizontal: 10, paddingVertical: 8, borderWidth: 1, width: 76},
  ...
  privacy: {flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16},
