...
const models: VehicleModelOption[] = [
  {id: '1', make: 'Toyota', model: 'Yaris', yearFrom: 2017, yearTo: 2024, vehicleType: 'CAR', seats: 5},
  {id: '2', make: 'Hyundai', model: 'i10', yearFrom: 2018, yearTo: 2024, vehicleType: 'CAR', seats: 5},
  {id: '3', make: 'Bajaj', model: 'RE', yearFrom: 2018, yearTo: 2024, vehicleType: 'MOTO', seats: 3},
];
