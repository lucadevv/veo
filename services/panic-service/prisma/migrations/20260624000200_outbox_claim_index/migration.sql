...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "outbox_events_published_at_failed_at_claimed_at_created_at_idx" ON "panic"."outbox_events"("published_at", "failed_at", "claimed_at", "created_at");
