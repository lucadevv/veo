...
CREATE SEQUENCE "media"."outbox_events_seq_seq";
ALTER TABLE "media"."outbox_events" ADD COLUMN "seq" BIGINT;
ALTER TABLE "media"."outbox_events" ALTER COLUMN "seq" SET DEFAULT nextval('"media"."outbox_events_seq_seq"');
ALTER SEQUENCE "media"."outbox_events_seq_seq" OWNED BY "media"."outbox_events"."seq";
...
SET "seq" = s.rn
FROM (
  SELECT "id", nextval('"media"."outbox_events_seq_seq"') AS rn
  FROM "media"."outbox_events"
  WHERE "seq" IS NULL
  ORDER BY "created_at" ASC, "id" ASC
) AS s
WHERE o."id" = s."id";
ALTER TABLE "media"."outbox_events" ALTER COLUMN "seq" SET NOT NULL;
