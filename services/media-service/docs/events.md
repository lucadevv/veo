...
| `media.access_granted` *(propuesto)* | `{ requestId, tripId, segmentId, operatorId, operatorEmail, approvedBy, watermark, expiresAt, at }` | aprobación de acceso a video (BR-S02) | **audit-service** (cadena de custodia) |
