 ...
 * Usar `prisma.write` para escrituras y lecturas post-write críticas; `prisma.read` para el resto.
 * Mismo patrón que identity-service.
 */
...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  constructor(config: ConfigService<Env, true>) {
    // El ctor de Prisma es genérico (Subset); lo adaptamos al ctor estructural del wrapper.
