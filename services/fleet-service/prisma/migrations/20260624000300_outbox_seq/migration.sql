...
CREATE SEQUENCE "fleet"."outbox_events_seq_seq";
ALTER TABLE "fleet"."outbox_events" ADD COLUMN "seq" BIGINT;
ALTER TABLE "fleet"."outbox_events" ALTER COLUMN "seq" SET DEFAULT nextval('"fleet"."outbox_events_seq_seq"');
ALTER SEQUENCE "fleet"."outbox_events_seq_seq" OWNED BY "fleet"."outbox_events"."seq";
...
UPDATE "fleet"."outbox_events" AS o
SET "seq" = s.rn
FROM (
  SELECT "id", nextval('"fleet"."outbox_events_seq_seq"') AS rn
  FROM "fleet"."outbox_events"
  WHERE "seq" IS NULL
  ORDER BY "created_at" ASC, "id" ASC
) AS s
WHERE o."id" = s."id";
ALTER TABLE "fleet"."outbox_events" ALTER COLUMN "seq" SET NOT NULL;
