/**
 * Cliente Redis compartido (locks de cron de vencimientos, cache de lecturas calientes).
 */
import { type Provider, type OnApplicationShutdown, Logger } from '@nestjs/common';
