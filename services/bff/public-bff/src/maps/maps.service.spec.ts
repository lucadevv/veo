...
import { categoryFareCents, DEFAULT_BID_FLOOR_CENTS, RIDE_CATEGORIES } from './fare';
...
describe('MapsService.quote', () => {
  it('modo FIXED: ruta + opciones con priceCents firme; SIN bidFloor/suggested', async () => {
    ...
    expect(out.options).toHaveLength(RIDE_CATEGORIES.length);
    ...
    // Ola 2B: la primera opción es el tier MOTO (mototaxi, vehicleType MOTO).
