...
CREATE SEQUENCE "notification"."outbox_events_seq_seq";
ALTER TABLE "notification"."outbox_events" ADD COLUMN "seq" BIGINT;
ALTER TABLE "notification"."outbox_events" ALTER COLUMN "seq" SET DEFAULT nextval('"notification"."outbox_events_seq_seq"');
ALTER SEQUENCE "notification"."outbox_events_seq_seq" OWNED BY "notification"."outbox_events"."seq";
...
SET "seq" = s.rn
FROM (
  SELECT "id", nextval('"notification"."outbox_events_seq_seq"') AS rn
  FROM "notification"."outbox_events"
  WHERE "seq" IS NULL
  ORDER BY "created_at" ASC, "id" ASC
) AS s
WHERE o."id" = s."id";
ALTER TABLE "notification"."outbox_events" ALTER COLUMN "seq" SET NOT NULL;
