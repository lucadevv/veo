...
const MESSAGE = 'Tu código VEO es 482913. Válido 5 minutos. No lo compartas.';

/**
 * Construye un fetch espía que captura la request y devuelve una respuesta 202 con el cuerpo dado.
...
describe('NotificationSmsSender', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
