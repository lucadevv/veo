...
CREATE SEQUENCE "share"."outbox_events_seq_seq";
ALTER TABLE "share"."outbox_events" ADD COLUMN "seq" BIGINT;
ALTER TABLE "share"."outbox_events" ALTER COLUMN "seq" SET DEFAULT nextval('"share"."outbox_events_seq_seq"');
ALTER SEQUENCE "share"."outbox_events_seq_seq" OWNED BY "share"."outbox_events"."seq";
...
UPDATE "share"."outbox_events" AS o
SET "seq" = s.rn
FROM (
  SELECT "id", nextval('"share"."outbox_events_seq_seq"') AS rn
  FROM "share"."outbox_events"
  WHERE "seq" IS NULL
  ORDER BY "created_at" ASC, "id" ASC
) AS s
WHERE o."id" = s."id";
ALTER TABLE "share"."outbox_events" ALTER COLUMN "seq" SET NOT NULL;
