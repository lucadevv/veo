...
Liveness **ACTIVO** (challenge: `TURN_LEFT|TURN_RIGHT|NOD|SMILE`, one-shot, `expiresAt`) obligatorio cada turno, **sin bypass ni override de UI**. 3 fallos = bloqueo 1h (solo central destraba). _(Distinto del KYC: turno=ACTIVO, KYC=PASIVO.)_
